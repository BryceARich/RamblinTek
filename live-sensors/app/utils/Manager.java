...
public class Manager {
    ...
    public JSONObject addDoc(double temp, int sensor, double time) throws Exception{ // need to make sure Solr recognizes this as a double
        ...
        */
        ...
        StringEntity entity  = new StringEntity(
                "{\"add\": { \"doc\": {\"id\": \" "+  time + " \",\"temp\":"+ temp +", \"sensor\":"+sensor+"}}}", "UTF-8");
        ...
        JSONObject obj = new JSONObject("{\"id\": \" "+  time + " \",\"temp\":"+ temp +", \"sensor\":"+sensor+"}");
        return obj;
    }
